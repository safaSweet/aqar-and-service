...
function Index() {
  ...
  const data = useSelector(
    (state) => state.category.get_categorys.data?.data?.msg//["Property\\TypeCategory"]
  );
 console.log('dataCategry',data)
                ...
                <CListGroupItem className=" d-flex justify-content-between">
                  <div>
                    <CBadge
                      color="success"
                      onClick={() => {
                        handleSetActive("create_category");
                    ...
                    <CBadge
                      color="danger"
                      onClick={() => {
                        dispatch(deleteCategory(data.id)).then(() => {
                          dispatch(getCategory());
                        });
                      }}
                    >
