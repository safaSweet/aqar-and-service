...
import { createPublication, editPublication } from "./Store";
...
function Create_Update() {
  ...
  function HandlerSubmit(e) {
    e.preventDefault();
    dispatch(createPublication(type));
  }
  function HandlerSubmitEdit(e) {
    const type=typ;
    e.preventDefault();
    dispatch(editPublication({type,id}));
  }

  return (
    <>
      <CModal visible={visible}
       onClose={() =>{handleSetCreateUpdate(false); handleSetVisible(false)}}
       >
        <CModalHeader 
        onClose={() =>{handleSetCreateUpdate(false);  handleSetVisible(false)}}
        >
