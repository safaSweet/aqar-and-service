...
import { deletePublication, getPublications } from "./Store";
...
function Index() {
  ...
  const data = useSelector(
    (state) => state.publication.get_publications.data?.data?.TypePublication//["Property\\TypePublication"]
  );
  ...
  return (
    <>
      ...
      >
        ...
        onClose={() => handleSetVisible(false)}
        >
          <CModalTitle> تفاصيل أنواع النشر</CModalTitle>
        </CModalHeader>
        <CModalBody>
          {data &&
            data.map((data, index) => (
                ...
                <CListGroupItem className=" d-flex justify-content-between">
                  <div>
                    <CBadge
                      color="success"
                      onClick={() => {
                        handleSetActive("create_publicatiion");
                    ...
                    <CBadge
                      color="danger"
                      onClick={() => {
                        dispatch(deletePublication(data.id)).then(() => {
                          dispatch(getPublications());
                        });
                      }}
                    >
